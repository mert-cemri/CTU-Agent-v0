...
# GRPO + Taxonomy Feedback Training on Retail Domain - 3B Model
# This script trains Qwen2.5-3B-Instruct on retail domain with LLM Judge feedback
...
MODEL_NAME_SANITIZED=$(echo $POLICY_MODEL | tr '/' '_')_retail_grpo_taxonomy_v11_after_sft
...
echo "========================================="
echo "Starting 3B GRPO + Taxonomy Training on Retail Domain"
echo "========================================="
...
HYDRA_FULL_ERROR=1 python main_tau_bench.py \
  ...
  trainer.project_name="tau_bench_retail_grpo_after_sft" \
