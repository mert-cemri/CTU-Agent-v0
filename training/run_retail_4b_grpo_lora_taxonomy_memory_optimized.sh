...
# Memory-Optimized GRPO Training with LoRA + LLM Judge (Taxonomy) - Retail Domain - 4B Model
# This script includes LLM Judge feedback with aggressive memory optimizations
...
WANDB_PROJECT="tau_bench_retail_grpo_lora_taxonomy_memory_opt"
...
echo "=========================================="
echo "Memory-Optimized LoRA GRPO Training with LLM Judge - Retail Domain"
...
echo "Memory-optimized taxonomy training completed!"
