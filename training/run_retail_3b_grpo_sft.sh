...
MODEL_NAME_SANITIZED=$(echo $POLICY_MODEL | tr '/' '_')_retail_grpo_vanilla_v11_after_sft
...
# PyTorch memory optimization - remove expandable_segments (incompatible with VLLM)
